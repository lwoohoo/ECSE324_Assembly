...
MAIN:
	...
	ldr a2, n		// ||
	ldr a3, i		// ||
	push {lr}		//retain place in prog.
	bl RIS			//function call
	pop {lr}		//restore link reg
STOP:
	b STOP
RIS:
	push {v1-v5}		//callee-save
...
END:
	...
	pushge {lr}		//{if above true, push link register on stack
	blge RIS		//{if above true, proceed to recursive function call
	popge {lr}		//{if above true restore link register from stack
	pop {v1-v5}		//restore variable registers  - callee-save
	bx lr			//return